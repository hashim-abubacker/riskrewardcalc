...
export function LocaleSelector({ onLocaleChange }: LocaleSelectorProps) {
    ...
    return (
        <select
            ...
            className="bg-[#18181b] border border-[#27272A] rounded-lg px-3 py-1.5 text-xs text-white hover:border-[#10B981]/50 focus:outline-none focus:border-[#10B981] transition-colors"
